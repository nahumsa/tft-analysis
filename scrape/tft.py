...
class TFTScraper():
    ...
    def from_summoner_name(self, name: str) -> Payload:
        summonder_url = f"https://br1.api.riotgames.com/tft/summoner/v1/summoners/by-name/{name}"
    ...
    def get_match_details_from_id(self, id: str) -> Payload:
        match_details_url = f"https://americas.api.riotgames.com/tft/match/v1/matches/{id}"
